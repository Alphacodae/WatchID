...
export default function FacialRecognitionOverlay({
  ...
  const retryVerification = () => {
    ...
    console.log(`Verification successful: Age ${detectedAge}`);
  };

  const handleDenied = (detectedAge: number, requiredAge: number) => {
    console.log(`Verification denied: Age ${detectedAge} < ${requiredAge}`);
  };
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="space-y-2">
                <h3 className={cn(
                  ...
                  {result === "success" ? "Verification Successful" : "Verification Denied"}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {result === "success" 
